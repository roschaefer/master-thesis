...
\section{Related Technologies for Coordinated Multiple Views}
This section introduces relevant libraries, frameworks and standards.
These technologies are either considered or used for the implementation of the \cmv{} system in Chapter~\ref{sec:implementation}.

\textbf{CrossfilterJS}
The Crossfilter library is one of the very few examples of an interaction framework for \cmvs{}.
...
\section{Guidelines for Multiple Views}\label{sec:related-work:guidelines}
...
\section{Interaction Aspects}\label{sec:related-work:interaction-aspects}
...
\subsection{Interaction Categories}\label{sec:related-work:interaction-aspects:categories}
...
\todo[inline]{Mehr related work on interaction aspects, Konferenz erwähnen}
