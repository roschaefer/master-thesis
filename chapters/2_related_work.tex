...
\begin{figure}[ht]
	...
	\caption{Traditional visualization of a tree in form of a directed graph with edges and nodes}\label{fig:related-work:tree-graph}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \copyrightbox[b]{%
        \includegraphics[width=\textwidth]{figures/related-work/german-exports-1}}{%
...
\begin{figure}[ht]
    \centering
    \copyrightbox[b]{%
        \includegraphics[width=\textwidth]{figures/related-work/german-exports-2}}{%
        \hfill \ccAttribution{} \ccShareAlike{} Observatory of Economic Complexity~\cite{Macro2017}
    }
