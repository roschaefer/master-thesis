...
\section{Interaction Categories}\label{sec:related-work:interaction-aspects:categories}
...
Yet, they only consider interactions in the domain of Focus+Context visualizations, not in data visualization in general.
