...
\begin{figure}[ht]
	...
	\caption{Traditional visualization of a tree in form of a directed graph with edges and nodes with the root node at the top}\label{fig:related-work:tree-graph}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{A tree map of Germany's foreign trade quota of exports, showing only the first hierarchy level}
...
\begin{figure}[ht]
    ...
    \caption{A tree map of Germany's foreign trade quota of exports, showing a hierarchy of depth ``HS4''}\label{fig:related-work:treemap-german-exports-2}
\end{figure}
...
\todo[inline]{Nothing to do with treemaps}
...
\begin{figure}[h]
  \centering
  \copyrightbox[b]{\includegraphics[width=\textwidth]{figures/related-work/cmv_example}}{\hfill Crossfilter\cite{Bostock2017}}
