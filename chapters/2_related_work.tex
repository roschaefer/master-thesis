...
\begin{figure}[ht]
  \centering
  \caption{Bertin's~\parencite{Bertin2010} original visual variables.}
...
\begin{figure}[ht]
  ...
  \copyrightbox[b]{%
    ...
    \hfill National Center for Chronic Disease Prevention and Health Promotion~\parencite{NCCDPHP2017}
  }
\end{figure}
...
\begin{figure}[ht]
    ...
    \copyrightbox[b]{%
        ...
        \hfill \ccAttribution{} \ccShareAlike{} Observatory of Economic Complexity~\parencite{Macro2017}
    }
\end{figure}
...
\begin{figure}[ht]
  ...
  \copyrightbox[b]{%
    ...
    \hfill \textcopyright{} Hasso-Plattner-Institut\parencite{Doellner2017}
  }
\end{figure}
...
\begin{figure}[h]
  \centering
  \caption{\cmv{} displaying the popularity, number of comments, location and time of pictures in a picture data base.}
  \label{fig:related-work:cmv}
  \copyrightbox[b]{\includegraphics[width=\textwidth]{figures/related-work/cmv}}{\hfill Dukevis\parencite{Dukevis2017}}
\end{figure}
...
\begin{figure}[h]
  ...
  \copyrightbox[b]{\includegraphics[width=\textwidth]{figures/related-work/brushing_linking}}{\hfill Crossfilter\parencite{Bostock2017}}
\end{figure}
