...
\textbf{Angular, Ember, ReactJS, Vue}
...
This section covers the smaller part of research in \cmvs{}:
Everything that is \emph{not} related to a high-level classification of interactions.
...
In this work, interactions are not agnostic of the underlying data structure and visualization.
