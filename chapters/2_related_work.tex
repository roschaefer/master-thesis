...
This section introduces terminology, describes the development and shows an example of each data visualization technique.
...
Nevertheless it is unclear, which visualization techniques are the most suitable to be used in combination.
