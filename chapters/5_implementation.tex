...
The views are implemented with \attr{React} and the geographical visualization uses \attr{Leaflet} internally.
...
As the central part of the software, the \attr{MultiviewController} is also used for certain performance optimizations.
