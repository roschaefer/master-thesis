...
\attr{PubSubJS} allows nested topics, therefore categories and purposes are encoded as nested strings.
Nested topics make it possible to subscribe to all interactions of category \attr{select}, e.g.\ \attr{mcv.select.highlight} and \attr{mcv.select.focus}, by subscribing to \attr{mcv.select}.
