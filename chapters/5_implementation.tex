...
The \attr{Input/Output} middleware in our case is the browser, as we develop a web based application.
...
The GeoJSON property \attr{user_count_normalized} encodes a percentage of a user base per region.
