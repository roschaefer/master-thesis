...
The message $M$ is composed of a verb $V$, an application specific purpose $P$ and an interaction subject $IS$.
The part of the interaction which is shared among multiple views is the message $M$.

The verb $F$ is defined by the triggering view at runtime.
...
\subsection{Verb}
An verb is the declaration and definition how the subject of the interaction should be changed.
The aforementioned explicit meaning of the interaction is the smallest unit of information of the interaction.

Some examples of verbs include: Selection, Deletion, Point-of-Interest, Filtering, Reordering, Re-encoding.
Verbs can be classified with the interaction categories of \textcite{Yi2007}.
...
The application context refers to the exclusive state of the specific application.
...
\section{Predefined verbs}\label{sec:concept:types}
...
The name of the function is the \emph{verb} and the function domain being the \emph{subject} of the interaction.
...
To coordinate the highlighting, the bar chart view will formulate a new message composed of a \emph{Select} function and the verb \emph{highlight}.
...
The verb determines the signature of the function and describes the interaction itself.
...
Every view can subscribe to certain interactions and receive messages in form of changed verbs.
