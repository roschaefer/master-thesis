...
\subsubsection{Hierarchical visualizations}
...
\subsubsection{Geographic Data Visualizations}
...
\textbf{Detail view or Mini View}
\begin{figure}
  \centering
...
\begin{table}[H]
  \begin{tabular*}{\textwidth}{lll}
    ...
    Explore & Accelerate scrolling by scrolling in the secondary view & Zoom factor \\
  \end{tabular*}
...
In this subsection, we list a set of formal requirements imposed on a \cmv{} framework.
These requirements can be used in Section~\ref{sec:evaluation} for further evaluation.
