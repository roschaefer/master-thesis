...
\section{Software Requirements for Coordinated Multiple Views}\label{sec:analysis:requirements}
...
\section{Considerations about client-side component frameworks}\label{sec:analysis:frontend-framework-comparison}
...
\begin{figure}
  \centering
  \subfloat[Histogram]{{\includegraphics[width=0.4\textwidth]{figures/analysis/histogram} }}%
  \qquad
  \subfloat[Population Pyramid]{{\includegraphics[width=0.4\textwidth]{figures/analysis/population-pyramid} }}%
...
\begin{figure}
  ...
  \qquad
  \subfloat[.. with baseline]{{\includegraphics[width=0.3\textwidth]{figures/analysis/stacked-bar-with-baseline.png} }}%
