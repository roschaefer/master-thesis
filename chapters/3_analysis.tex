...
\hline
    \cellcolor{lightgreen}{standard} & \cellcolor{lightred}{string-based attributes} &  \cellcolor{lightred}{non-standard}   \\
\hline
...
\begin{figure}
  \centering
  \subfloat[Bubble Chart]{{\includegraphics[width=0.4\linewidth]{figures/analysis/bubble-chart.png} }}%
  \qquad
  \subfloat[Scatter plot]{{\includegraphics[width=0.4\linewidth]{figures/analysis/scatter-plot.png} }}%
...
\begin{figure}
  \centering
  \subfloat[Stacked bar chart]{{\includegraphics[width=0.3\linewidth]{figures/analysis/stacked-bar-without-baseline.png} }}%
  \qquad
  \subfloat[.. with baseline]{{\includegraphics[width=0.3\linewidth]{figures/analysis/stacked-bar-with-baseline.png} }}%
...
\begin{figure}
  \centering
  \subfloat[Tree map]{{\includegraphics[width=0.4\linewidth]{figures/analysis/treemap.png} }}%
  \qquad
  \subfloat[Sunburst diagram]{{\includegraphics[width=0.4\linewidth]{figures/analysis/sunburst.png} }}%
...
\begin{figure}
  \centering
  \subfloat[Choropleth map]{{\includegraphics[width=0.4\linewidth]{figures/analysis/choropleth-map.png} }}%
  \qquad
  \subfloat[Flow map]{{\includegraphics[width=0.4\linewidth]{figures/analysis/flow-map.png} }}%
...
\begin{figure}
  \centering
  \subfloat[Calendar]{{\includegraphics[width=0.4\linewidth]{figures/analysis/calendar.png} }}%
  \qquad
  \subfloat[Gantt chart]{{\includegraphics[width=0.4\linewidth]{figures/analysis/gantt-chart.png} }}%
