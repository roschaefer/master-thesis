...
\begin{figure}[h]
  ...
  \caption{}\label{fig:evaluation:performance:profiling:immoscout_both:fps}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/evaluation/performance/profiles/immoscout_both/summary}
  \caption{}\label{fig:evaluation:performance:profiling:immoscout_both:summary}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{figures/evaluation/performance/profiles/immoscout_both/callstack}
  \caption{}\label{fig:evaluation:performance:profiling:immoscout_both:callstack}
\end{figure}
