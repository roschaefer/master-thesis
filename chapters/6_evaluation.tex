...
\todo[inline]{How long does it take for each scenario?}
...
Whereas the data with the most features is called ``Immoscout Wohnungsangebote'' with 8601 coordinates German real estates, totalling 2.11 MiB.

\begin{table}[ht]
  \centering
  \begin{tabular}{llll}
    Name & Number of features & Type of features & Size of GeoJSON \\
    \hline
    Bundesländer Deutschland      & 16   & Areas  & 0.64 MiB \\
    Tankstellen Berlin            & 366  & Points & 0.75 MiB \\
    Wahlkreise BT 2009            & 299  & Areas  & 0.91 MiB \\
    Regierungsbezirke Deutschland & 31   & Areas  & 0.94 MiB \\
    Immoscout Wohnungsangebote    & 8601 & Points & 2.11 MiB \\
    Landkreise Deutschland        & 402  & Areas  & 2.13 MiB \\
  \end{tabular}
