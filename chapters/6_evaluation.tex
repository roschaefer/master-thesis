...
The following performance evaluation was carried out on a machine with hardware specifications listed in Table~\ref{tab:evaluation:performance:hardware}
