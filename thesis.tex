...
Every view is responsible of its \emph{triggers}, these are implementation details and not part of the interaction framework.
...
\begin{figure}[h!]
  ...
  \caption{%
    Message flow of the communication pattern.
