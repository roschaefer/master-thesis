...
According to the Interaction Design Foundation, data visualizations serve two purposes: sense-making and communication.
...
Figure~\ref{fig:theory:visual-variables} shows the seven visual variables introduced by \textcite{Bertin2010}.
...
\begin{figure}[h]
    \centering
    \copyrightbox[b]{%
        \includegraphics[width=\textwidth]{images/treemap_example}}{%
        \hfill \ccAttribution{} \ccShareAlike{} Observatory of Economic Complexity~\cite{Macro2017}
    }
    \caption{German exports visualized as a tree map}\label{fig:research:treemap}
\end{figure}

\paragraph{\threedTmaps{} and \tmaps} is a concept introduced by \textcite{Bladh2004} in 2004.
...
\begin{figure}[h]
  \centering
  \copyrightbox[b]{%
    \includegraphics[width=\textwidth]{images/choropleth_example}}{%
    \hfill GPLv3 Mike Bostock\cite{Bostock2017:2}
  }
  \caption{Unemployment rate in the USA}\label{fig:research:choropleth}
\end{figure}
