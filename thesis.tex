...
We can use this data as input for our common visual analytics software, e.g. figure~\ref{fig:implementation:user_distribution} shows the user distribution of \rufu{}.
