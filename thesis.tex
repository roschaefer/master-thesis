...
In order to achieve maximal flexibility and to avoid $N*N$ transformations for $N$ visible views, we define a common interface.
This interface is capable of communicating all necessary interaction information for all variations of chart types.
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{images/chartTypes/bar-chart.png}
  \end{center}
  \caption{An ordinary bar chart}
  \label{fig:concept:chart-types:bar-chart}
\end{figure}
...
\subsubsection{Stacked bar charts and baselines}


\begin{figure}
  \centering
    \subfloat[Stacked bar chart]{{\includegraphics[width=0.4\textwidth]{images/chartTypes/stacked-bar-without-baseline.png} }}%
    \qquad
    \subfloat[Stacked bar chart with baseline]{{\includegraphics[width=0.4\textwidth]{images/chartTypes/stacked-bar-with-baseline.png} }}%
