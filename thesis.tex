...
\subsection{Use-case specific interactions}
...
For \tmaps{} and \maps{} we can categorize the interaction techniques according to the schema:

\begin{table}
  \begin{tabular}{p{0.2\textwidth} p{0.4\textwidth} p{0.4\textwidth}}
    \toprule
    Interaction        & \tmaps{} & \maps{}  \\
    \cmidrule(r){1-3}
    Select              & Click one box or click on a group of boxes                                                     & Click on a building, an area or a point \\
    Explore             & Rotate the \tmap{}, focus on a box                                                             & Move, rotate, pan or zoom the viewpoint, focus on an area \\
    Reconfigure         & Choose a different feature for layouting                                                       & Place different polygons on the map \\
    Encode              & Choose a different feature for data mapping of visual attributes like color, height or texture & Choose a different color for polygons \\
    Abstract/ Elaborate & Increase the level of hierarchy, .ie increase maximal nesting                                  & Increase the level of detail, e.g. shwo postal codes instead of federal states \\
    Filter              & Filter data by an attribute but do the layouting with another attribute                        & Filter data by an attribute and color data based on another attribute  \\
    Connect             & Highlight boxes in the same subtree                                                            & Highlight neighboring regions \\
    \bottomrule
  \end{tabular}
\end{table}
