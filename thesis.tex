...
We formalize each interaction from Section~\ref{sec:analyis} as a mathematical function and group these functions together if they have the same input and output.
