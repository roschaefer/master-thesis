...
Until today, there is no framework that simplifies the implementation of multiple views and their interactions.
Neither is there a specification of the interfaces and their requirements, a formalization of an interaction or a messaging pattern for the coordination of interactions.
...
\begin{enumerate}
  ...
  \item
    What are the main characteristics of an interaction?
  \item
    What entities are affected by interactions?
  \item
    What is a good communication protocol for multiple views?
  \item
    What is a minimal yet complete interface for one data visualization in group of \cmvs{}?
  % \item
