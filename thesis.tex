...
\subsection{Trigger, effect and interaction information}
...
\begin{enumerate}
    ...
    \item 
        The relevant interaction information is ambiguous.
    \item 
...
For the second case, we can see an ambiguity of interaction information if we look at line diagrams and a bar charts.
...
It is possible to describe interactions in any type of data visualization by looking on the \emph{trigger}, the \emph{effect} and the exchanged \emph{interaction information}.
Coordinating interactions across multiple views then means to make a reasonable choice of \emph{trigger} and \emph{effect} for every view and then define what data is included in the \emph{interaction information}.
