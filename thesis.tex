...
So the views are components and their closest common ancestor is the \cmv{} itself, controlling state and passing user interaction down to it's children. can be viewed as a component and the \cmv{} itself as the component that controls the user interaction and passes it down to all contained views.
