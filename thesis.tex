    ...
    \begin{center}
        ...
        {\small
            \begin{tabulary}{\textwidth}{ll}
                ...
                \bf Encode & Change colours of data series (dictionary of data series \rightarrow \ colour) \\
    ...
    \begin{center}
        ...
        {\small
            \begin{tabulary}{\textwidth}{ll}
                ...
                \bf Encode & Change colours of data series (dictionary of colours \rightarrow \ data series) \\
    ...
    \begin{center}
        ...
        {\small
            \begin{tabulary}{\textwidth}{ll}
                ...
                \bf Encode & Change mapping of colour to category (dictionary of data series \rightarrow \ colour) \\
                \bf Encode & Change colour function (function value \rightarrow \ colour) \\
                \bf Encode & Change data attribute to for colour (data attribute) \\
                \bf Encode & Change data attribute to for size \\
                \bf Reconfigure & Sort by attribute (data attribute) \\
                \bf Reconfigure & Drag bars to reorder data series (ordered list of ids of data points) \\
                \bf Filter & Hide a data series (id of data series) \\
            \end{tabulary}
...
\begin{figure}
    \begin{center}
        ...
        {\small
            \begin{tabulary}{\textwidth}{ll}
                \bf Select & Highlight a bar (id of data point) \\
                \bf Encode & Change mapping of category to colour (dictionary of data series \rightarrow \ colour) \\
                \bf Reconfigure & Sort by attribute (data attribute) \\
