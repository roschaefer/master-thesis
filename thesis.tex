...
\begin{enumerate}
    ...
    \item
        ...
        Elements of this set may include the name for $x-axis$ and $y-axis$ or the name of shapes, like $star$ or $circle$.
        Thus, an \emph{encoding} interaction can change the mapping of a data attribute to another coordinate axis.
\end{enumerate}

Note about notation:
The power set of all entities in $E$ is written as $ \mathbb{P(\mathbb{E})}$ and is the set of all subsets of $E$.
...
\begin{enumerate}
    ...
    \item
        ...
        It can also be implemented based on the values in $\mathbb{D}$ of attached attributes in $\mathbb{A}$ of the entity.
        E.g.\ a threshold function would be an example of the latter.
    \item
    ...
    \item
        ...
        This function returns a subset of entities that are supposed to be within the current boundaries of the diagram window.
    ...
    \item
        $ Reorder: \varnothing \rightarrow \mathbb{E^*} $
    ...
    \item
        $ Sort: \mathbb{E} \times \mathbb{E} \rightarrow \mathbb{R} $

        The $Sort$ function is used to order two arbitrary entities $e1, e2 \in \mathbb{E}$.
