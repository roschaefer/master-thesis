...
\begin{figure}[h!]
  ...
  \label{fig:theory:visual-variables}
\end{figure}
...
\begin{figure}
  ...
  \label{fig:concept:chart-types:detail}
  \caption{The screenshot-tool ``shutter'' shows a magnified detail view of the area around the mouse cursor in the lower right corner of the screen}
\end{figure}
