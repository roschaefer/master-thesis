...
\begin{figure}[h]
  ...
  \caption{%
    ...
    Minard accomplished to represent six values in two graphical dimensions:
...
\paragraph{Focus+Context Visualization} by \textcite{Bjork1999} is one of the very few formal descriptions of information visualization.
The authors structure the process into three parts:
\subparagraph{Visualizations} referred to as $IV$, are triples of a set $[D]$ of underlying data, a visual representation $V$ and $I$ which is the interactivity. 
\begin{equation}
  IV([D], V, I)
\end{equation}
...
When $V$ is affected by $I$ the user can manipulate $IV$ in order to change the way $[D]$ is represented, e.g.\ choosing a different level of detail as in Figures~\ref{fig:theory:treemap-german-exports-1} and~\ref{fig:theory:treemap-german-exports-2}.
