...
\begin{enumerate}
    \item
        ...
        It can be used to mark entities for deletion as well as to open an edit dialog.

        This function is also used to focus the visualization on an entity.
        During a focusing $Select$ a geographical map will move the viewpoint position and the zoom level such that all focused entities are visible.
    ...
    \item
        ...
        Implicit implementations would be based on the values of the dimensions in $\mathbb{D}$ of the entity.
