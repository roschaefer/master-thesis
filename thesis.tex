...
Some examples of interaction types include: Highlighting, Deletion, Point-of-Interest, Filtering, Reordering, Re-encoding.
...
Therefore the colour would not be changed for an interaction of type \emph{Highlighting} but the texture of the bubble.
