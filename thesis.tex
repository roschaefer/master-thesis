...
\subsection{Application of interactions}
...
\begin{figure}[h!]
  ...
  \caption{A data structure for tabular, hierarchical and relational data}
  \label{fig:concept:meta-data-structure}
\end{figure}

\subsection{Interaction semantics}\label{sec:concept:semantics}
...
The name of the function is the \emph{intention} of the interaction and the function domain being the \emph{subject} of the interaction.
...
For the sake of explicitly, we define a couple of sets:
\begin{enumerate}
    \item
        $ \mathbb{I} : \mathbb{I} \subseteq \mathbb{N} $
    ...
    \item
        ...
        The set of possible values of any attribute in our subject space. Those values could be e.g.\ numbers, strings, ordinal values, dates or geometries.
    \item
        $ \mathbb{C}: \{ (r,g,b) \in \mathbb{C} | r \in \mathbb{R} \land g \in \mathbb{R} \land b \in \mathbb{R} \}$

        The set of colours, we assume $R$, $G$ and $B$ values.
    \item
        $ \mathbb{S} $

        The set of all discrete shapes.
\end{enumerate}

The following is a list of functions describing the semantics based on the aforementioned sets:
\begin{enumerate}
    \item
        $ Highlight: \varnothing \rightarrow \mathcal{P}(\mathbb{I})$

        A $ Highlight $ is a function without arguments returning a subset of highlighted entities.
    \item
        $ FilterById: \varnothing \rightarrow \mathcal{P}(\mathbb{I}) $

        The $FilterById$ function takes no arguments and returns a subset of entities that are used as input for the visualization.
    \item
        $ FilterByValue: \mathbb{V^*} \rightarrow \{ \bot, \top \} $

        The $FilterByValue$ function takes an ordered list of attribute values and returns whether or not the associated entity should be part of the visualization input.
    \item
    ...
    \item
        $ Focus: \varnothing \rightarrow \mathbb{I} $
    ...
    \item
        $ Extent: \varnothing \rightarrow \mathcal{P}(\mathbb{I}) $
    ...
    \item
        $ ColourByValue: \mathbb{V} \rightarrow \mathbb{C} $
    ...
    \item
        $ Order: \rightarrow \mathbb{I^*} $

        The $Order$ function defines how a subset of entities should be ordered.
    ...
    \item
        $ Sort: \big( \mathbb{V^*} \times \mathbb{V^*} \big) \rightarrow \mathbb{R} $
    ...
    \item
        $ X: \varnothing \rightarrow \mathbb{A} $
    ...
    \item
        $ Y: \varnothing \rightarrow \mathbb{A} $
    ...
    \item
        $ Size: \varnothing \rightarrow \mathbb{A} $
    ...
    \item
        $ LayoutAttribute : \varnothing \rightarrow \mathbb{A} $
    ...
    \item
        $ Shape : \mathbb{I} \rightarrow \mathbb{S} $
        Visualizations displaying a shape per data point, $Shape$ will return a shape for every entity.
\end{enumerate}
...
While semantics describe the \emph{intention} of the interaction and the \emph{subject}, they do not describe the actual \emph{coordination} of views.
...
We regard the messages exchanged between views as a change of those interaction semantics defined in~\ref{sec:concept:semantics}
