...
If a view wants to coordinate an interaction, it can exchange this information via a dedicated function. 
...
\begin{enumerate}
    ...
    \item 
        $ Sort: (\mathbb{R} \times \mathbb{R})^* \rightarrow \mathbb{R} $

        This sort function will return a continuous value based on a arbitrary long list of pairs of attribute values.
        It's an implicit order function based on one or many data attributes.
    \item 
