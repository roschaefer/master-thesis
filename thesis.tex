...
A sentence is the information that is send from one view to another in order to coordinate an interaction.
...
\begin{equation}
  S(V, T, F)
\end{equation}
With $V$ as a verb, an interaction type $T$ and a function $F$.
